...
<div class="container my-5">
    <nav aria-label="breadcrumb" class="mb-4">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="OrderController?action=history" class="text-gold text-decoration-none">Hồ sơ giao dịch</a></li>
    ...
    <div class="d-flex justify-content-between align-items-end mb-4 border-bottom border-warning pb-2">
        ...
        <a href="OrderController?action=history" class="btn btn-outline-luxury btn-sm px-3 py-2">
