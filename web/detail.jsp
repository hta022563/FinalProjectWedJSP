                    ...
                    <c:choose>
                        ...
                        <c:otherwise>
                            <div class="bg-light p-4 rounded-3 text-center border">
                                <i class="fa-solid fa-lock fs-1 text-muted mb-3 opacity-50"></i>
                                <h6 class="text-dark fw-bold mb-3">Vui lòng đăng nhập!</h6>
                                <p class="text-muted small mb-4">Bạn cần đăng nhập tài khoản để có thể gửi đánh giá cho siêu xe này.</p>
                                <a href="login.jsp" class="btn btn-outline-danger fw-bold w-100 py-2 rounded-3">
