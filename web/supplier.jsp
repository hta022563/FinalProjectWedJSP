...
<div class="container-fluid py-5 px-5">
    ...
    <div class="aero-card p-4 mb-5 border-start border-info border-5">
        <h5 class="fw-bold mb-4 d-flex align-items-center" style="color: #3a7bd5;">
            <span class="bg-info bg-opacity-10 p-2 rounded-3 me-3"><i class="fa-solid fa-building-shield text-info"></i></span> Thiết lập đối tác cung ứng mới
        </h5>
                ...
                <tbody class="bg-white">
                    <c:forEach items="${listSupplier}" var="sup">
                        <tr>
                            ...
                            <td>
                                <button type="button" class="btn btn-outline-info btn-sm rounded-pill px-3 me-2 border-0 fw-bold" data-bs-toggle="modal" data-bs-target="#editModalSupplier${sup.supplierID}">Sửa</button>
                                <a href="MainController?target=Supplier&action=delete&id=${sup.supplierID}" class="btn btn-outline-danger btn-sm rounded-pill px-3 border-0 fw-bold" onclick="return confirm('Ngừng hợp tác với đơn vị này?')">Xóa</a>
                            </td>
                        </tr>
                    </c:forEach>
                </tbody>
