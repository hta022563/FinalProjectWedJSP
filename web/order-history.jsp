                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex justify-content-center gap-2">
                                            ...
                                            <c:choose>
                                                <%-- Nút Hủy chuẩn xác được đặt ở đây --%>
                                                <c:when test="${order.status == 'Pending'}">
                                                    <a href="MainController?target=Order&action=cancelOrder&orderId=${order.orderID}" class="btn btn-sm btn-outline-danger-lux px-3" onclick="xoaDonHang(event, this.href, '${order.orderID}')">
                                                        Hủy
                                                    </a>
                                                </c:when>
