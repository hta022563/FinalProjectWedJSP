...
<div class="p-5 text-center bg-image" style="background-image: url('IMG/505329.jpg'); height: 400px; background-size: cover; background-position: center;">
        ...
        <div class="col-md-4 mb-4">
            <div class="card h-100 border-0 shadow-sm hover-shadow">
                ...
                <div class="card-body">
                    ...
                    <h5 class="text-danger fw-bold">5,000,000,000 VNĐ</h5>
                </div>
        ...
        <div class="col-md-4 mb-4">
            <div class="card h-100 border-0 shadow-sm hover-shadow">
                ...
                <div class="card-body">
                    ...
                    <h5 class="text-danger fw-bold">4,500,000,000 VNĐ</h5>
                </div>
                <div class="card-footer bg-white border-0 text-center pb-3">
        ...
        <div class="col-md-4 mb-4">
            <div class="card h-100 border-0 shadow-sm hover-shadow">
                ...
                <div class="card-body">
                    ...
                    <h5 class="text-danger fw-bold">1,500,000,000 VNĐ</h5>
                </div>
                <div class="card-footer bg-white border-0 text-center pb-3">
...
<c:if test="${not empty msg}">
    <script>
        Swal.fire({ title: 'Thành công!', text: '${msg}', icon: 'success', confirmButtonText: 'Đóng', confirmButtonColor: '#dc3545' });
    </script>
</c:if>
