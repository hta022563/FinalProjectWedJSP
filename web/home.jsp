...
<div class="container mt-5 pt-5 mb-5" id="showroom">
    ...
    <div class="text-center mt-5 pt-3">
        <a href="ProductController" class="btn btn-outline-luxury rounded-pill px-5">XEM TOÀN BỘ KHO XE</a>
    </div>
</div>
...
<div class="container my-5 py-5 border-top border-secondary">
    <div class="row align-items-center">
        ...
        <div class="col-lg-6 px-lg-5 text-start">
            <span class="fw-bold mb-2 d-block text-uppercase" style="letter-spacing: 2px; font-size: 0.85rem;">
                <span class="text-white">CÂU CHUYỆN</span> <span class="text-gold">THƯƠNG HIỆU</span>
            </span>
            <h2 class="luxury-title mb-4" style="font-size: 2.2rem;">ĐỈNH CAO CỦA <br> SỰ HOÀN MỸ</h2>
            <p class="mb-4" style="line-height: 1.8; color: #a0a0a0; font-size: 0.95rem;">
                F-AUTO không chỉ là nơi mua bán siêu xe, chúng tôi mang đến một phong cách sống thượng lưu. Với triết lý "Khách hàng là trọng tâm", mỗi chiếc xe tại F-AUTO đều phải trải qua 150 bước kiểm định khắt khe nhất trước khi lăn bánh đến tay chủ nhân.
            </p>
            <p class="mb-5" style="line-height: 1.8; color: #a0a0a0; font-size: 0.95rem;">
                Sứ mệnh của chúng tôi là biến ước mơ sở hữu những cỗ máy tốc độ hoàn mĩ nhất thế giới của bạn thành hiện thực một cách dễ dàng và minh bạch nhất.
            </p>
            <a href="NewsController" class="btn btn-luxury rounded-pill">ĐỌC THÊM VỀ CHÚNG TÔI</a>
        </div>
    </div>
</div>
...
<div class="test-drive-banner text-center">
    <div class="container">
        ...
        <p class="text-light mb-5 fs-5 mx-auto" style="max-width: 700px; line-height: 1.6;">
            Hãy trực tiếp cầm vô lăng và cảm nhận sức mạnh của những cỗ máy thời gian hoàn hảo nhất.
        </p>
        ...
        <div class="col-md-4">
            <div class="process-box">
                ...
                <div class="process-content">
                    ...
                    <p class="text-secondary small line-height-16">Truy cập bộ sưu tập xe đa dạng của chúng tôi, nhận tư vấn chuyên sâu và chọn ra mẫu xe phản ánh đúng đẳng cấp của bạn.</p>
                </div>
            </div>
        </div>
        <div class="col-md-4">
            <div class="process-box">
                ...
                <div class="process-content">
                    ...
                    <p class="text-secondary small line-height-16">Hoàn tất thủ tục thanh toán nhanh chóng với đa dạng phương thức và sự hỗ trợ toàn diện về giấy tờ sang tên, ra biển số.</p>
                </div>
            </div>
        </div>
        <div class="col-md-4">
            <div class="process-box">
                ...
                <div class="process-content">
                    ...
                    <p class="text-secondary small line-height-16">Nhận chìa khóa xe tận tay tại Showroom hoặc yêu cầu dịch vụ vận chuyển xe chuyên dụng đến tận cửa garage nhà bạn.</p>
                </div>
            </div>
        </div>
    </div>
...
<div class="container-fluid py-5 border-top border-secondary" style="background-color: #0d0d0d;">
    <div class="container py-4">
        <div class="d-flex justify-content-between align-items-end mb-5">
            <div>
                <h2 class="luxury-title mb-0" style="font-size: 2rem;">TIN TỨC & SỰ KIỆN</h2>
            </div>
            <a href="NewsController" class="btn btn-outline-luxury rounded-pill d-none d-md-inline-block">XEM TẤT CẢ</a>
        </div>
        ...
        <div class="row g-4">
            <div class="col-md-4">
                <div class="news-card h-100 pb-3">
                    <div class="car-img-wrapper">
                        <img src="IMG/Por.jpg" class="card-img-top" alt="Tin tức 1" style="height:220px; object-fit:cover">
                    </div>
                    <div class="card-body p-4 text-start">
                        <p class="text-gold small mb-2 fw-bold"><i class="fa-regular fa-calendar me-1"></i> 10/11/2026</p>
                        <h5 class="card-title text-white fw-bold mb-3" style="font-size: 1.1rem; line-height: 1.5;">Porsche 911 thế hệ mới chính thức cập bến F-AUTO</h5>
            ...
            <div class="col-md-4">
                <div class="news-card h-100 pb-3">
                    <div class="car-img-wrapper">
                        <img src="IMG/lambo.jpg" class="card-img-top" alt="Tin tức 2" style="height:220px; object-fit:cover">
                    </div>
                    <div class="card-body p-4 text-start">
                        <p class="text-gold small mb-2 fw-bold"><i class="fa-regular fa-calendar me-1"></i> 05/11/2026</p>
                        <h5 class="card-title text-white fw-bold mb-3" style="font-size: 1.1rem; line-height: 1.5;">Mercedes S-Class 2026: Định nghĩa lại sự xa xỉ</h5>
                        <p class="text-secondary small mb-4" style="display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical; overflow: hidden;">
            ...
            <div class="col-md-4">
                <div class="news-card h-100 pb-3">
                    <div class="car-img-wrapper">
                        <img src="IMG/505329.jpg" class="card-img-top" alt="Tin tức 3" style="height:220px; object-fit:cover">
                    </div>
                    <div class="card-body p-4 text-start">
                        <p class="text-gold small mb-2 fw-bold"><i class="fa-regular fa-calendar me-1"></i> 01/11/2026</p>
                        <h5 class="card-title text-white fw-bold mb-3" style="font-size: 1.1rem; line-height: 1.5;">Triển lãm Siêu Xe F-AUTO Motor Show 2026</h5>
                        <p class="text-secondary small mb-4" style="display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical; overflow: hidden;">
        ...
        <div class="text-center mt-4 d-md-none">
            <a href="NewsController" class="btn btn-outline-luxury rounded-pill px-5">XEM TẤT CẢ</a>
        </div>
    </div>
</div>
